...
If you're [building a custom Filament theme](https://filamentphp.com/docs/5.x/styling/overview), you need one more step to make the editor theme match your custom theme.
